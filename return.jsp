...
pstmt=con.prepareStatement("Update transaction set flag='"+flag1+"' where userid='"+ userid +"'and id0='"+ id0 +"' and id1='"+ id1 +"' and id2='"+ id2 +"' and id3='"+ id3 +"'");
...
//        out.println(authorname[ii]);
    ...
    final String subject = "Book Return To Charusat Library by You.";
    final String messg = total;
    request.setAttribute("errorMessage1", "Book Return Successfully"); 
